...
import { builtinDelete, builtinGet, builtinSet } from "./built-in.ts";
import {
  normalizeSetOptions,
...
import { externalDelete, externalGet, externalSet } from "./external.ts";
import { assertCacheKey, type CacheKey } from "./key.ts";
import { encodeCacheValue } from "./payload.ts";
