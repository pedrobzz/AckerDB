...
export const MCP_TOKEN_PREFIX = "ackerdb_mcp.";
const PUBLIC_ID_LENGTH = 22;
const SECRET_LENGTH = 43;
const MCP_TOKEN = new RegExp(
  `^ackerdb_mcp\\.([A-Za-z0-9_-]{${PUBLIC_ID_LENGTH}})\\.([A-Za-z0-9_-]{${SECRET_LENGTH}})$`,
);
...
/** MCP HTTP accepts either no credential or one exact parsed AckerDB MCP bearer. */
