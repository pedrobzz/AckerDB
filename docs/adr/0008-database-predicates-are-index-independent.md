...
AckerDB ordinary reads start from a table query, build typed SQL predicates, and
...
unique lookup. Existing user-named physical indexes reconcile once into AckerDB's
