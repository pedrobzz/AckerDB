...
export function benchmarkConfigFromEnv(): BenchmarkConfig {
  ...
  return {
    ...
    operation: {
      warmupMs: positiveInt("BENCH_WARMUP_MS", quick ? 250 : 1_000),
      steadyMs: positiveInt("BENCH_STEADY_MS", quick ? 500 : 3_000),
      trials: positiveInt("BENCH_TRIALS", quick ? 1 : 3),
    ...
    connections: {
      ...
      workMs: positiveInt("BENCH_CONNECTION_WORK_MS", quick ? 500 : 2_000),
    ...
    subscriptions: {
      ...
      durationMs: positiveInt("BENCH_SUB_DURATION_MS", quick ? 500 : 5_000),
      ...
      capacityDurationMs: positiveInt("BENCH_SUB_CAPACITY_DURATION_MS", quick ? 500 : 10_000),
